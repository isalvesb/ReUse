...
export function IncentiveCard({
  ...
  const isFirstItem = userItemCount === 0;
  ...
  return (
    <View style={styles.incentiveCard}>
      ...
      <Text style={styles.incentiveTitle}>
        {isFirstItem
          ? "Publique agora seu primeiro item"
          : `Você já publicou ${userItemCount} item${
              userItemCount > 1 ? "s" : ""
            }`}
      </Text>
      ...
      <Text style={styles.incentiveBody}>
        {isFirstItem
          ...
          : "Continue publicando itens e desbloqueie novas recompensas no ReUse."}
      </Text>
      ...
      <TouchableOpacity style={styles.publishBtn} onPress={onPublish}>
        <Text style={styles.publishBtnText}>Entendi</Text>
      </TouchableOpacity>
    </View>
  );
}
    ...
    >
      <Animated.View style={[styles.overlay, { opacity: fadeAnim }]}>
        ...
        >
          ...
          <Text style={styles.incentiveBody}>
            Publique seu primeiro item e desbloqueie benefícios incríveis! Veja o
            que te aguarda:
          </Text>
